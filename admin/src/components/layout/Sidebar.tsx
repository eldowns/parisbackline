  ...
  return (
    <aside className="w-64 bg-bg-secondary border-r border-border min-h-screen flex flex-col">
      <div className="p-6 border-b border-border">
        ...
        <p className="text-text-muted text-xs mt-0.5">Management System</p>
      </div>
      ...
      <div className="p-3 border-t border-border">
        <button
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-text-secondary hover:text-danger hover:bg-danger/5 transition-colors w-full cursor-pointer"
        >
          <svg className="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
